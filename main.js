...
// function myWa() {
//   window.open("https://wa.me/6285640389741", "_blank");
// }

// onClick("instagram", myIg);
// function myIg() {
//   setInner("instagram", "Haloo cuy....");
// }
...
function responseFunction(response) {
  ...
  document.getElementById("profile-name").textContent =
    details.name || "Nama Tidak Ditemukan";
  document.getElementById("company-name").textContent =
    details.occupation || "Pekerjaan Tidak Ditemukan";
  document.getElementById("job-title").textContent =
    details.about[0]?.value || "Deskripsi Tidak Ditemukan";
  document.getElementById("email").textContent =
    details.social_links[0]?.url.replace("mailto:", "") ||
    "Email Tidak Tersedia";
  document.getElementById("phone").textContent =
    details.social_links[1]?.url.replace("https://wa.me/", "") ||
    "Telepon Tidak Tersedia";
  document.getElementById("address").textContent =
    details.social_links[2]?.url || "Alamat Tidak Tersedia";
  document.getElementById("rate").textContent =
    details.rate_day.price || "Tarif Tidak Diketahui";
